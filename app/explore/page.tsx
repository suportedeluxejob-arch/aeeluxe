...
export default function ExplorePage() {
  ...
  const loadExploreContent = async () => {
    try {
      ...
      // Silent error handling - Firebase index errors won't show to user
      // The page will gracefully show empty states instead
      setBronzeHighlights([])
      setBronzePosts([])
    } finally {
      setLoading(false)
  ...
  return (
    <ResponsiveLayout>
      <div className="min-h-screen bg-gradient-to-b from-background via-background to-purple-950/10 pb-20 lg:pb-6">
              ...
              <div className="relative flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Aqui você encontra apenas conteúdos Bronze gratuitos. Assine para acessar conteúdos exclusivos
                    Prata, Gold, Platinum e Diamante.
                  </p>
                </div>
                ...
                {bronzeHighlights.map((story) => (
                  <div key={story.id} onClick={() => openStory(story)} className="flex-shrink-0 cursor-pointer group">
                    <div className="w-[100px]">
                      <AspectRatio
                        ratio={9 / 16}
                        className="rounded-xl overflow-hidden shadow-lg ring-2 ring-purple-600/20 group-hover:ring-purple-600/40 transition-all"
                      >
                        <img
                          ...
                          <div className="relative">
                            ...
                            <Avatar className="relative h-8 w-8 ring-2 ring-background">
                              ...
                              <AvatarFallback className="text-xs">
                                {story.creatorProfile?.displayName?.[0]}
                              </AvatarFallback>
                            </Avatar>
                          </div>
                        </div>
        ...
        {selectedStory && (
          <div className="fixed inset-0 z-50 bg-black flex items-center justify-center">
            {/* Progress Bars */}
            <div className="absolute top-0 left-0 right-0 flex gap-1 p-2 z-10 max-w-md mx-auto">
            ...
            {/* Header */}
            <div className="absolute top-4 left-0 right-0 flex items-center justify-between px-4 z-10 max-w-md mx-auto">
            ...
            {/* Navigation Areas */}
            <div className="absolute inset-0 flex max-w-md mx-auto">
