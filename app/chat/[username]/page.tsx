...
export default function ChatWithCreator() {
  ...
  useEffect(() => {
    ...
    const loadProfiles = async () => {
      ...
      try {
        const [currentUserProfile, targetProfile, isCreator] = await Promise.all([
          getUserProfile(user.uid),
          getUserByUsername(username),
          isUserCreator(user.uid),
        ])
        ...
        const canChat = isCreator || ["gold", "platinum", "diamante"].includes(userLevel)
