...
import { LogOut, LayoutDashboard, Users, UserCog, Bell, DollarSign, Network, Menu, X, UserPlus } from "lucide-react"
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/admin/creators/create-first", label: "Criar 1ª Criadora", icon: UserPlus },
