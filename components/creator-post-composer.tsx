...
export const CreatorPostComposer = memo(function CreatorPostComposer({
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (isVideo && file.size > maxSize) {
      ...
      alert(
        `Vídeo muito grande (${sizeMB}MB).\n\nLimite: 4MB\n\nDica: Use um compressor de vídeo online para reduzir o tamanho mantendo a qualidade.`,
      )
      return
    }
    ...
    try {
      ...
      if (isImage) {
        try {
          ...
          console.log("[v0] Image cropped to 1080x1080 square format")
        } catch (error) {
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            className="h-12 w-12 p-0 bg-background/50 flex-shrink-0"
                          ...
                          <Input
                            ...
                            className="h-12 text-center text-xl font-bold flex-1 bg-background/50"
                            min="0"
                          />
                          <Button
                            variant="outline"
